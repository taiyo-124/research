...
\section{2025/04/25}
\begin{itemize}
    \item 今日は2限にテストがあった. 準備不足感もあったが4問中3問できたので単位は大丈夫かと
    \item 平井さんのメタルラックから色々持ってきた. そろそろ備品管理しないと何がどこにあるのかわからなくなりそうなので, wikiにメモしようかな
    \item 主な発見物
    \begin{itemize}
        \item UTS基盤: Arduinoベースらしい. LTE通信モジュールも確認した.→Arduinoの動作を確認した後(知識ないので時間かかりそう), LTE通信したい(SIMカード必要)
        \item Lora通信モジュール(黄色): 適切にピンをつなぐことで自動でModeを変更できる基盤. パラメータ変更のためにモードを変更する必要あり.
    \end{itemize}
